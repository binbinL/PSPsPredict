...
from config import train_root,val_root, batch_size,n_epoch,lr,dropout,save_root,d_model,n_class,vocab_size,nlayers,nhead,dim_feedforward,d_embedding,kmers # type: ignore
